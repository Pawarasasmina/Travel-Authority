  ...
  return (
    <div className="bg-gray-50 min-h-screen">
                            ...
                            <tr key={activity.id} className="hover:bg-gray-50 transition-colors duration-200">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div className="flex space-x-2">
                                  <button
                                    className="p-2 text-blue-600 hover:text-blue-900 hover:bg-gray-100 rounded-lg transition-colors duration-200"
                                  ...
                                  <button
                                    className="p-2 text-green-600 hover:text-green-900 hover:bg-gray-100 rounded-lg transition-colors duration-200"
                                    title="Edit Activity"
                                  ...
                                  <button
                                    className="p-2 text-red-600 hover:text-red-900 hover:bg-gray-100 rounded-lg transition-colors duration-200"
      ...
      {showDetailsModal && selectedActivity && (
        <>
          <div className="fixed inset-0 bg-black bg-opacity-50 z-40 backdrop-blur-sm" onClick={() => setShowDetailsModal(false)} />
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">{selectedActivity.title}</p>
                    </div>
                  </div>
                  <button
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-6">
                  <div className="w-full md:w-1/3">
                    <img 
                      src={selectedActivity.image || 'https://via.placeholder.com/400x300?text=No+Image'} 
                  ...
                  <div className="w-full md:w-2/3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h4 className="text-sm text-gray-500 uppercase mb-1">Location</h4>
                        <p className="text-lg font-semibold">{selectedActivity.location}</p>
                      </div>
                      
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h4 className="text-sm text-gray-500 uppercase mb-1">Price</h4>
                        <p className="text-lg font-bold">Rs. {selectedActivity.price}</p>
                      </div>
                      
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h4 className="text-sm text-gray-500 uppercase mb-1">Availability</h4>
                        <p className="text-lg font-semibold">{selectedActivity.availability} spots</p>
                      </div>
                      
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h4 className="text-sm text-gray-500 uppercase mb-1">Duration</h4>
                        <p className="text-lg font-semibold">{selectedActivity.duration || 'Not specified'}</p>
                      </div>
                      
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h4 className="text-sm text-gray-500 uppercase mb-1">Rating</h4>
                        <div className="flex items-center">
                          <span className="text-lg font-semibold mr-2">{selectedActivity.rating}</span>
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                              <svg key={i} className={`w-5 h-5 ${i < Math.floor(selectedActivity.rating) ? 'text-yellow-500' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                ...
                {selectedActivity.additionalInfo && (
                  <div className="mb-6 bg-gray-50 p-5 rounded-xl border border-gray-200">
                    ...
                    <p className="text-gray-700">{selectedActivity.additionalInfo}</p>
                  </div>
                )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {selectedActivity.highlights.map((highlight, index) => (
                        <div key={index} className="flex items-start">
                          <div className="p-1 bg-gray-200 rounded-full mr-2 mt-0.5">
                        ...
                        <div key={index} className="p-4 bg-white rounded-lg border border-gray-200">
                              ...
                              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                {pkg.features.map((feature, featIndex) => (
                                  <li key={featIndex} className="flex items-center text-sm">
                                    <div className="p-0.5 bg-gray-200 rounded-full mr-2">
                          ...
                          <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
                            <div>
                              ...
                              <span className="font-medium ml-1">Rs. {pkg.foreignAdultPrice || pkg.price}</span>
                            </div>
                            <div>
                              <span className="text-gray-600">Foreign Kid:</span>
                              <span className="font-medium ml-1">Rs. {pkg.foreignKidPrice || Math.floor(pkg.price * 0.7)}</span>
                            </div>
                            <div>
                              <span className="text-gray-600">Local Adult:</span>
                              <span className="font-medium ml-1">Rs. {pkg.localAdultPrice || pkg.price}</span>
                            </div>
                            <div>
                              <span className="text-gray-600">Local Kid:</span>
                              <span className="font-medium ml-1">Rs. {pkg.localKidPrice || Math.floor(pkg.price * 0.7)}</span>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                  <button
                    ...
                    className="px-5 py-2.5 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 flex items-center"
                  >
