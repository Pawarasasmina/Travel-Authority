...
import contactbg from "../assets/about-us/contact.png"
...
export default function AboutUs() {
    return (
        ...
        <div className="font-sans text-gray-800">
          ...
          {/* Contact Form */}
          <section className="relative bg-cover bg-center py-10 max-w-6xl rounded-[10px] mx-auto mb-8" style={{ backgroundImage: `url(${contactbg})` }}>
            <div className="container mx-auto px-16">
              <div className="flex">
                <div className="w-full md:w-6/12 lg:w-5/8">
                  <h2 className="text-white text-4xl font-extrabold mb-6 text-center">Contact Us</h2>
                  <form className="space-y-5">
                    <input
                      type="text"
                      placeholder="Name"
                      className="w-full p-4 text-lg rounded-md focus:outline-none"
                    />
                    <input
                      type="email"
                      placeholder="Email"
